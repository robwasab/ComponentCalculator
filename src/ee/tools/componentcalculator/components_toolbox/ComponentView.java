...
public class ComponentView extends Component implements ComponentViewInterface {
	...
	float bodyWidth_over_textSize = -1;
	...
	private void init() 
	{
		if (body != null)
		{
			...
			this.bodyWidth_over_textSize = (float) (body.getWidth()/30.0);
		}
		else
		{
			origin_y = 0;
	...
	{	
		if (new_text_size > 10 && this.bodyWidth_over_textSize != -1)
		{
			text_size = new_text_size;
			text_paint.setTextSize(text_size);
			if (body != null)
			{
				double new_body_width = this.bodyWidth_over_textSize * text_size;
				body.setWidth((float)new_body_width);
			}
			return true;
		}
		return false;
	...
	public void resetShrink()
	{
		...
		text_paint.setTextSize(30);	
		if (body != null)
			body.setWidth((float) (30.0 * this.bodyWidth_over_textSize));
	}
	...
	private void recalculate()
	{
		...
		if (body != null)
		{
			...
			text_width = text_paint.measureText(value);
